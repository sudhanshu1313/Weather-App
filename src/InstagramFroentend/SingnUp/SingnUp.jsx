...
const passReagex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})/;
...
const postData = () =>{
  if(!emailRegex.test(email)){
    ...
    notifyA("Password must contain at least eight charaters , including at least 1 number and 1 includes both lower and upercase letters and special charactrs for example A,b, @,#,$,0")
    return
  }
      ...
      <center>
           ...
           <div className=' MainDIV'>
             ...
             <div className='row mt-3'>
                <div>
                  <img src="https://logos-download.com/wp-content/uploads/2016/03/Instagram_Logo_2016.png" width="150px" height="60px"/>
                </div>
                <div>
             ...
             <div className='row'>
                <div className='mt-2 Sections'>
                  ...
                  <div>                
                      ...
                      <button value={SingnUp} className='BTN' onClick={()=>{postData() }}>Sign Up</button>
                  </div>
                </div>
             </div>
