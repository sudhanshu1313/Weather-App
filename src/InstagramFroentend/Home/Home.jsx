                       ...
                       return(
                        ...
                        <div className='card'>
                                ...
                                <div className='card-header'>
                                    ...
                                    <h5 style={{fontFamily:'sans-serif'}}>{value.postedBy.name}</h5>
                                ...
                                <div className='card-contaent'>
                                    {
                                        value.likes.includes(JSON.parse(localStorage.getItem("user"))._id) 
                                        ?
                                        (
                                    ...
                                    <p style={{fontFamily:'sans-serif'}}>{value.likes.length} Likes</p>
                                    <p style={{fontFamily:'sans-serif'}}>{value.body}</p>
                                    
                                    <p onClick={()=>{toggleComment(value)}} style={{fontFamily:'sans-serif',fontWeight:'bolder',color:'gray',cursor:'pointer'}}>View all comments</p>

                                </div>

                                <div className='add-comment'>
                                    <span className="material-symbols-outlined">mood</span>
                                    <input type='text' placeholder='Add comments ..!' value={comment} onChange={(e)=>{setComment(e.target.value)}} style={{fontFamily:'sans-serif'}}/>
                                    <button className='comment' onClick={()=>{makeComment(comment,value._id)}} >Post</button>
                                </div>
                         ...
                         <div className='Container'>
                             ...
                             <div className="details">
                                 ...
                                 <div className='card-header' style={{borderBottom:'1px solid black'}}>
                                         ...
                                         <h5 style={{fontFamily:'sans-serif'}}>{item.postedBy.name}</h5>
     
                                 </div>
     
                                 {/* comments section */}
                                 <div className="comment-sections" style={{borderBottom:'1px solid black'}}>
                                    {
